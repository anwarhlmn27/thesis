                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <form action="{{ route('thesis-advisors.destroy', $advisor->id) }}" method="POST" onsubmit="return confirmDelete(event, this)" class="d-inline" data-confirm-message="Apakah Anda yakin ingin menghapus pembimbing skripsi ini?">
                                            @csrf
                                            @method('DELETE')
