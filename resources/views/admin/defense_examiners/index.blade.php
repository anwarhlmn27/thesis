                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <form action="{{ route('defense-examiners.destroy', $examiner->id) }}" method="POST" onsubmit="return confirmDelete(event, this)" class="d-inline" data-confirm-message="Apakah Anda yakin ingin menghapus penguji sidang ini?">
                                            @csrf
                                            @method('DELETE')
