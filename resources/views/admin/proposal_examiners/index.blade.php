                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <form action="{{ route('proposal-examiners.destroy', $examiner->id) }}" method="POST" onsubmit="return confirmDelete(event, this)" class="d-inline" data-confirm-message="Apakah Anda yakin ingin menghapus penguji seminar ini?">
                                            @csrf
                                            @method('DELETE')
