<!--**********************************
            Nav header start
        ***********************************-->
        <div class="nav-header" style="background-color: #ffffff !important;">
            <a href="{{ route('dashboard') }}" class="brand-logo p-0 d-flex justify-content-center align-items-center" style="width: 100%; height: 100%;">
                <img src="{{ asset('images/profile/logo_UHI.png') }}" alt="Logo UHI" style="max-width: 100%; max-height: 60px; object-fit: contain;">
            </a>
