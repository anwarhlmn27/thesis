            ...
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<div class="col-xl-3 col-md-6">
						<div class="card">
							<img class="img-fluid rounded-top" src="{{ asset('assets/images/courses/pic1.jpg') }}" alt="">
							<div class="card-body">
					...
					<div class="col-xl-3 col-md-6">
						<div class="card">
							<img class="img-fluid rounded-top" src="{{ asset('assets/images/courses/pic2.jpg') }}" alt="">
							<div class="card-body">
					...
					<div class="col-xl-3 col-md-6">
						<div class="card">
							<img class="img-fluid rounded-top" src="{{ asset('assets/images/courses/pic3.jpg') }}" alt="">
							<div class="card-body">
					...
					<div class="col-xl-3 col-md-6">
						<div class="card">
							<img class="img-fluid rounded-top" src="{{ asset('assets/images/courses/pic4.jpg') }}" alt="">
							<div class="card-body">
